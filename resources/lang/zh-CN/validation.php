...
return [
    ...
    */
    ...
    'distinct'             => ':attribute字段不能重复',
    'email'                => ':attribute必须是有效的邮箱地址',
    'exists'               => '此:attribute是无效的',
    'file'                 => ':attribute必须是文件',
    'filled'               => ':attribute字段必须有一个值',
    'image'                => ':attribute必须是图片',
    'in'                   => '已经选择的:attribute是无效的',
    'in_array'             => ':attribute不属于:other.',
    'integer'              => ':attribute必须是有效的整数',
    'ip'                   => ':attribute必须是有效的IP',
    'ipv4'                 => ':attribute必须是有效的IPV4地址',
    'ipv6'                 => ':attribute必须是有效的IPV6地址',
    'json'                 => ':attribute必须是有效的JSON字符',
    'max'                  => [
